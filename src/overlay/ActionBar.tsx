import type { CaptureMode, RegionRect } from '../shared/types';
...
export function ActionBar({ selection, mode, busy, onCopy, onSave, onRecord, onCancel }: Props) {
  const BAR_H = 36;
  const BAR_W = mode === 'record' ? 220 : 200;
  ...
  return (
    ...
    >
      {mode === 'screenshot' ? (
        ...
        <button className={btn} onClick={onRecord} title="Start recording (Enter)">
